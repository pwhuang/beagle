...
InputParameters validParams<AuxPerturb>()
{
  ...
  params.addRequiredCoupledVar("temp", "Peturbation will be applied on this kernel.");
...
AuxPerturb::AuxPerturb(const InputParameters & parameters) :
