...
InputParameters validParams<VelocityDiffusion_half>()
{
  ...
  params.addCoupledVar("temperature","temperature is required for VelocityDiffusion_half.");
  params.addParam<unsigned>("component_1", "x y z component");
  params.addParam<unsigned>("component_2", "x y z component");
  params.addParam<Real>("sign", "The positive or negative sign of VelocityDiffusion_half");
  params.addParam<Real>("scale", "The scale of the cross differentiation term. VelocityDiffusion_half");
  return params;
}

VelocityDiffusion_half::VelocityDiffusion_half(const InputParameters & parameters) :
...
Real
VelocityDiffusion_half::computeQpResidual()
{
...
Real
VelocityDiffusion_half::computeQpJacobian()
{
...
Real
VelocityDiffusion_half::computeQpOffDiagJacobian(unsigned jvar)
{
