...
{
  return _time_coefficient*_heat_capacity[_qp]*TimeDerivative::computeQpResidual();
}

Real
ExampleTimeDerivative::computeQpJacobian()
{
  return _time_coefficient*_heat_capacity[_qp]*TimeDerivative::computeQpJacobian();
}
