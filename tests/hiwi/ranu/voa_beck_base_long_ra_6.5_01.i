...
value ='0.2999999999999976*sin(pi*y)*cos(0*pi*x/1.5)*cos(1*pi*z/1.0) + 1.0-y'
  [../]

  [./ic_func_u]
    type = ParsedFunction

value ='-0.0*cos(pi*y)*sin(0*pi*x/1.5)*cos(1*pi*z/1.0)'
  [../]

  [./ic_func_v]
    type = ParsedFunction

value ='0.9749999999999922*sin(pi*y)*cos(0*pi*x/1.5)*cos(1*pi*z/1.0)'
  [../]

  [./ic_func_w]
    type = ParsedFunction

value ='-0.9749999999999922*cos(pi*y)*cos(0*pi*x/1.5)*sin(1*pi*z/1.0)'
  [../]
[]
