[Mesh]
  file = 'voa_beck_base_long_ra_6.6_11_initial.e'
  second_order = true
[]
...
[Functions]
  [./bc_func_v]
    type = ParsedFunction
    value = 'amp1*exp( - ( 0.5*((x-0.3)/sigma_x)^2 + 0.5*((z-0.7)/sigma_z)^2 )) + amp2*exp( - ( 0.5*((x-1.2)/sigma_x)^2 + 0.5*((z-0.3)/sigma_z)^2 )) '
    vars = 'amp1 amp2 sigma_x sigma_z'
    vals = '10.0 -10.0 1e-2 1e-2'
  [../]
