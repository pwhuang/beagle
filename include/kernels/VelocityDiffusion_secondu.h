...
#ifndef VelocityDiffusion_secondu_H
#define VelocityDiffusion_secondu_H

#include "Diffusion.h"

//Forward Declarations
class VelocityDiffusion_secondu;
...
class VelocityDiffusion_secondu : public Diffusion
{
public:

  VelocityDiffusion_secondu(const InputParameters & parameters);
...
#endif //VelocityDiffusion_secondu_H
